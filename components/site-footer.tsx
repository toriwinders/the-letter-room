...
export function SiteFooter() {
  return (
    <footer className="mx-auto mt-20 w-full max-w-[64rem] border-t border-[var(--color-line)] pt-6 pb-2 text-[0.9rem] text-[var(--color-muted)] sm:mt-24">
      <div className="flex flex-col gap-5 sm:flex-row sm:items-start sm:justify-between">
        <div className="max-w-[22rem]">
          <p className="copy-rhythm text-[var(--color-ink)]">The Letter Room</p>
